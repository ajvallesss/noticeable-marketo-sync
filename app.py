...
MARKETO_LIST_ID = 1908  # Your target Marketo list ID
...
# Ensure we always have a valid token at startup
...
def add_subscriber_to_list(email):
    """Add a lead to the Marketo Static List by ID"""
    global MARKETO_ACCESS_TOKEN
...
# Webhook Route for Noticeable Events
...
if __name__ == "__main__":
    if len(sys.argv) > 1 and sys.argv[1] == "find_list":
        get_list_by_id()  # Run this if calling "find_list" from CLI
    else:
